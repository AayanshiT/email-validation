...
export default function Signup({ onNavigate }) {
  ...
  if (submitted) return (
    <div className="min-h-screen bg-gradient-to-br from-teal-500 to-blue-600 flex items-center justify-center px-4">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-500 via-teal-400 to-blue-500 flex flex-col">
      {/* Top bar */}
      <div className="bg-teal-600/60 backdrop-blur-sm py-3 text-center text-xs font-semibold text-white tracking-wide">
      ...
      <header className="py-4 flex justify-center">
        <div className="flex items-center gap-0.5">
          <span className="text-2xl font-black text-white tracking-tight">email</span>
          <span className="text-2xl font-black text-yellow-300">2</span>
          <span className="text-2xl font-black text-white tracking-tight">bounce</span>
        </div>
      </header>
        ...
        <div className="w-full max-w-6xl flex flex-col lg:flex-row items-center lg:items-start gap-10 pt-6">
          ...
          <div className="flex-1 text-white pt-4 lg:pt-10 text-center lg:text-left">
            ...
            <p className="text-base text-teal-100 mb-8 max-w-lg mx-auto lg:mx-0 leading-relaxed">
              email validation helps marketers, agencies, and businesses verify email lists, including catch-all email verification to reduce bounce rates, improve inbox placement, and maximise campaign ROI.
            </p>
            ...
            <div className="flex items-center gap-3 flex-wrap justify-center lg:justify-start">
              <div className="bg-white/10 backdrop-blur rounded-xl px-3 py-2 flex items-center gap-2">
                <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center text-xs font-bold">UK</div>
                <span className="text-xs text-white/80">Certified</span>
              </div>
              <div className="bg-white rounded-xl px-3 py-2 flex items-center gap-2">
                <div className="w-6 h-6 bg-blue-600 rounded flex items-center justify-center">
                  <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 1.944A11.954 11.954 0 012.166 5C2.056 5.649 2 6.319 2 7c0 5.225 3.34 9.67 8 11.317C14.66 16.67 18 12.225 18 7c0-.682-.057-1.35-.166-2.001A11.954 11.954 0 0110 1.944z" clipRule="evenodd"/></svg>
                </div>
                <span className="text-xs font-bold text-gray-700">SOC 2 TYPE II</span>
              </div>
              <div className="bg-white rounded-xl px-3 py-2 flex items-center gap-2">
                <span className="text-green-500 font-bold text-xs">★</span>
                <span className="text-xs font-bold text-gray-700">Trustpilot 4.1</span>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 flex-shrink-0">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div>
                ...
                <input name="email" type="email" value={form.email} onChange={handleChange} placeholder="me@company.com" required
                  className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-teal-400 focus:ring-2 focus:ring-teal-50 transition" />
              </div>
              ...
              <div>
                ...
                <div className="flex items-center border border-gray-200 rounded-xl overflow-hidden focus-within:border-teal-400 focus-within:ring-2 focus-within:ring-teal-50 transition">
                  <div className="flex items-center gap-1.5 px-3 py-2.5 bg-gray-50 border-r border-gray-200 text-sm text-gray-600 select-none">
                    🇮🇳 +91
                  </div>
              ...
              <div>
                ...
                <input name="business" value={form.business} onChange={handleChange} placeholder="Your Business Name"
                  className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-teal-400 focus:ring-2 focus:ring-teal-50 transition" />
              </div>
            ...
            <p className="text-center text-sm text-gray-500 mt-4">
              ...
              <button onClick={() => onNavigate?.("login")} className="text-teal-500 font-semibold hover:underline">
                Login
              </button>
            </p>
          </div>
