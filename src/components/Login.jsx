    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4">
      ...
      <div className="mb-8 text-center">
        <div className="flex items-center justify-center gap-1 mb-1">
          <span className="text-2xl font-black text-gray-900 tracking-tight">no</span>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 w-full max-w-sm px-8 py-10">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-teal-500 hover:bg-teal-600 disabled:bg-teal-300 text-white font-bold py-3 rounded-xl transition-all text-sm mt-1 flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
